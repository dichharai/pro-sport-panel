...
headers.append(ths[1].text.rstrip().split('[')[0])
...
for i in range(2, len(trs)):
    name = nationality = num = seasons = ''
    tds = trs[i].find_all('td')
    th = trs[i].find('th')
    name = th.a.string.rstrip()
    # print(name) prints name
    # print(th) # prints th with name of the player
    # print(tds) prints all tds
    # print(tds[0].text) # prints the text -- country
