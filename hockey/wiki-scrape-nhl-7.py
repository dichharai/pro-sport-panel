...
head1 = f'{headers[0]}{pattern1}|{pattern1}{headers[1]}{pattern1}|{pattern1}{headers[2]}|{pattern1}{headers[3]}{pattern1}'
...
for i in range(2, len(trs)):
    ...
    if len(tds) == 20:
        ...
        data = f'{name} | {nationality} | {num} | {seasons}'
        w_file.write(data + '\n')
        total_tenderer += 1
...
pattern1 = ' '*5
# print(f'{headers[0]}{pattern1}|{pattern1}{headers[1]}{pattern1}|{pattern1}{headers[2]}')
head2 = f'{headers[0]}{pattern1}|{pattern1}{headers[1]}{pattern1}|{pattern1}{headers[2]}|{pattern1}{headers[3]}'
w_file.write(head2 + '\n')

table_skaters = tables[5]
# print(table_skaters)
