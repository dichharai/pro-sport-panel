...
w_file_name = f'{write_file_name_list[0].lower()}-{write_file_name_list[1].lower()}-{write_file_name_list[2].lower()}-{write_file_name_list[3].lower()}.txt'
